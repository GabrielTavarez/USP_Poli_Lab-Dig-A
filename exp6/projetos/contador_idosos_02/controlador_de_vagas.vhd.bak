...
entity controlador_de_vagas is 
    port(
        ...
        vagas_total, vagas_load: in std_logic_vector (3 donwto 0);
        vagas_out_total, vagas_out_idosos : out std_logic_vector (3 donwto 0);
        cheio: out std_logic
    );
...
architecture arch of controlador_de_vagas is
    ...
    signal entra_sai_idoso_sm_dp_s, entra_sai_normal_sm_dp_s, conta_idoso_sm_dp_s, conta_normal_sm_dp_s, clear_sm_dp_s, cheio_dp_sm_s : std_logic;
    
    
begin  
    
    UC: unidade_de_controle port map(
        entra_sai_idoso <= ,entra_sai_idoso 
